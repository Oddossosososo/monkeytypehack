...
(()=>{"use strict";
const KEY="ArrowRight",defaults={wpm:50,accuracy:1,mode:"basic",minDelay:100,maxDelay:333,pauseDelay:100};
let cfg={...defaults,...JSON.parse(localStorage.getItem("autotyper-config")||"{}")},running=false,timer=null;
